...
@FeignClient(
    ...
    name = "cartao-bloqueios",
    fallback = Fallback.class)
public interface BloqueioSistemaExterno {

  @RequestMapping(
      method = RequestMethod.POST,
      value = "/api/cartoes/{id}/bloqueios",
      consumes = "application/json",
      produces = "application/json")
  BloqueioCartaoResponse bloqueiaCartao(
      @PathVariable("id") String id, @RequestBody BloqueioCartaoRequest bloqueioCartaoRequest);
}
