...
@FeignClient(url = "${sistema.cartao.conta.resource}", name = "cartao-viagens", fallback = Fallback.class)
public interface AvisoViagemSistemaExterno {
    ...
    ViagemCartaoResponse avisoViagem(@PathVariable("id") String id, @RequestBody ViagemCartaoRequest viagemCartaoRequest);
}
