...
public class CarteiraController implements SelecionaCartao {
  ...
  // 1
  @Autowired private NovaCarteiraSistemaExterno novaCarteiraSistemaExterno;
  ...
  public ResponseEntity<?> criar(
    ...
    if (carteiraRepository
        .findByCarteiraAndCartaoId(novaCarteiraRequest.getCarteira(), cartao.getId())
        .isPresent()) {
      assertNotNull(
          carteiraRepository.findByCarteiraAndCartaoId(
              novaCarteiraRequest.getCarteira(), cartao.getId()),
     ...
     * */
    // 1
    NovaCarteiraResponse novaCarteiraResponse =
        novaCarteiraSistemaExterno.novaCarteira(numeroCartao, novaCarteiraRequest);
