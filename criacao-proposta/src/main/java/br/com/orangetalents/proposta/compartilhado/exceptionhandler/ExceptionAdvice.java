...
public class ExceptionAdvice {
    ...
    public ResponseEntity<ExceptionPadronizado> handle(MethodArgumentNotValidException methodArgumentNotValidException) {
    ...
    public ResponseEntity<ExceptionPadronizado> handleApiErroException(ApiExceptionGenerico apiExceptionGenerico) {
        Collection<String> mensagens = new ArrayList<>();
