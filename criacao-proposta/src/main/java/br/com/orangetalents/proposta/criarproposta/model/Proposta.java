...
public class Proposta {
  ...
  @Transient private final Logger logger = LoggerFactory.getLogger(Proposta.class);
  ...
  @NotNull @Embedded private Endereco endereco;
  ...
  @OneToOne private Cartao cartao;
  ...
  public AnaliseClienteRequest fromModelToRequest() {
    ...
    return new AnaliseClienteRequest(this.getDocumento(), this.getNome(), this.getId());
  }
