...
public class NovaPropostaRequest {
  ...
  @NotNull @CpfCnpj private String documento;

  @NotBlank @Email private String email;

  @NotBlank private String nome;

  @NotNull @Valid private EnderecoRequest endereco;
  ...
  public Proposta toModel() {
    return new Proposta(
        this.email, this.documento, this.nome, this.endereco.toModel(), this.salario);
  }
