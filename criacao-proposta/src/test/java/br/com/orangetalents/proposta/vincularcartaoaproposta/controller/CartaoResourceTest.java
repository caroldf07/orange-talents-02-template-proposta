...
class CartaoResourceTest {
  @Autowired private WireMockServer mockSistemaCartao;
  @Autowired private CartaoResource cartaoResource;
  ...
  void liberaCartao() {
    Assertions.assertNotNull(
        cartaoResource.liberaCartao(new AnaliseClienteRequest("08588487080", "John", "1")));
  }
}
