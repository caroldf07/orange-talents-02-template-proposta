...
class AnaliseClienteResponseTest {
  ...
  static Stream<Arguments> gerador1() {
    return Stream.of(
        Arguments.of(
            ...
            new AnaliseClienteResponse(
                "12345667890", "teste", "1", ResultadoSolicitacao.SEM_RESTRICAO)),
        Arguments.of(
            StatusProposta.NAO_ELEGIVEL,
            new AnaliseClienteResponse(
                "12345667890", "teste", "1", ResultadoSolicitacao.COM_RESTRICAO)));
  }
  ...
  void getStatusProposta1(
      StatusProposta resultadoSolicitacao, AnaliseClienteResponse analiseClienteResponse) {
