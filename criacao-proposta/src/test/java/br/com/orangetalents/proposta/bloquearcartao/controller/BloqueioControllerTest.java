...
class BloqueioControllerTest {
    ...
    @Autowired
    private WireMockServer mockSistemaExternoBloqueio;
    ...
    void setUp() throws IOException {
        BloqueioSistemaExternoTestMock.setUpBloqueioSistemaExternoMockResponse(mockSistemaExternoBloqueio);
    }
    ...
    void bloqueia2() {
        ...
        Cartao cartaoBloqueado = cartaoRepository.findByIdAndStatusCartao("12345", StatusCartao.BLOQUEADO);
